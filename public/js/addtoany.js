...
var a2a = a2a || {
    ...
    dom: {
        isReady: !1, ready: function (e) {
            ...
            if ("complete" === document.readyState) a(); else if (document.addEventListener) document.addEventListener("DOMContentLoaded", t, !1), window.addEventListener("load", t, !1); else {
    ...
    init: function (e, a) {
        var t, n, i, o, l = a2a.c, r = (a = a || {}, {}), s = null, c = {}, d = location.href;
        for (var u in a2a.make_once(e), a) l[u] = a[u];
        for (var u in l) r[u] = l[u];
        if (n = l.target) if ("string" == typeof n) {
        ...
        (e = l.menu_type ? "mail" : e) && (a2a.type = e, l.vars.process()), c.type = a2a.type, c.node = s, c.linkmedia = l.linkmedia, c.linkname = l.linkname || document.title || location.href, c.linkurl = l.linkurl || location.href, c.linkname_escape = l.linkname_escape, c.linkname_implicit = !l.linkname_escape && (document.title || d) == c.linkname, c.linkurl_implicit = d == c.linkurl, c.orientation = l.orientation || !1, c.track_links = l.track_links || !1, c.track_links_key = l.track_links_key || "", c.track_pub = l.track_pub || !1, l.linkmedia = l.linkname = l.linkurl = l.linkname_escape = l.show_title = l.custom_services = l.exclude_services = l.orientation = l.track_pub = l.target = !1, "custom" == l.track_links && (l.track_links = !1, l.track_links_key = ""), a2a.last_type = a2a.type, window["a2a" + a2a.type + "_init"] = 1, function (e, a) {
            a2a.total++, a2a.n = a2a.total;
            var t, n, i = (a2a["n" + a2a.n] = e).node = a2a.set_this_index(e.node), o = document.createElement("div"),
                l = a2a.getData(i)["a2a-media"], r = a2a.getData(i)["a2a-title"], s = a2a.getData(i)["a2a-url"];
    ...
    init_all: function (a) {
        a2a.unindexed(function (e) {
            0 <= e.className.indexOf("a2a_follow") ? a2a.init("feed", {target: e}) : a2a.init(a || "page", {target: e})
    ...
    button: function (e) {
        var n = a2a.gEl, i = e.node, o = e.type, l = "a2a" + o, r = n(l + "_dropdown"), s = n(l + "_full"),
            a = a2a.has_menter, t = i.firstChild, c = a2a[o].onclick;
        i.getAttribute("onclick") && -1 != (i.getAttribute("onclick") + "").indexOf("a2a_") || i.getAttribute("onmouseover") && -1 != (i.getAttribute("onmouseover") + "").indexOf("a2a_") || (a2a.add_event(i, "click", function (e) {
            ...
            var a = "none" !== r.style.display, t = document.activeElement;
        ...
        }), a2a.add_event(i, "click", a2a.stopPropagation), a2a.add_event(i, "touchstart", a2a.stopPropagation, !!a2a.evOpts() && {passive: !0}), !a2a[a2a.type].onclick && a && (a2a.c.delay ? i.onmouseenter = function () {
    ...
    kit: function (o, e) {
        var a, t, n, i, l, d = o.type, r = {
            ...
            }, s = ["facebook_like", "twitter_tweet", "pinterest_pin", "linkedin_share"], c = a2a.counters.avail,
            u = function (e, a) {
                if (e && !a2a.in_array(e, s)) for (var t = 0, n = a ? a2a[d].services : a2a.services, i = n.length; t < i; t++) if (e == n[t][1]) return [n[t][0], n[t][2], n[t][3], n[t][4], n[t][5]];
                return !a && [e, e]
            }, p = function (e, a) {
            ...
            }, _ = a2a.c.templates, g = a2a.in_array, h = o.node, v = a2a.getData(h), y = h.className, k = h.a2a_follow,
            w = a2a.HTMLcollToArray(h.getElementsByTagName("a")), b = w.length, x = document.createElement("div"),
            A = encodeURIComponent, E = o.linkurl, C = A(o.linkurl).replace(/'/g, "%27"), S = o.linkname,
            B = (A(o.linkname).replace(/'/g, "%27"), o.linkmedia),
            T = (B && A(o.linkmedia).replace(/'/g, "%27"), v["a2a-icon-color"] || a2a.c.icon_color),
            F = T ? T.split(",", 2) : T, L = F ? F[0] : F, N = F ? F[1] : F,
            z = y.match(/a2a_kit_size_([\w\.]+)(?:\s|$)/), D = z ? z[1] : "16", I = D + "px",
            M = "a2a_svg a2a_s__default a2a_s_", j = {}, P = {},
            O = o.linkurl_implicit && a2a.canonical_url ? encodeURIComponent(a2a.canonical_url).replace(/'/g, "%27") : C,
            H = v["a2a-scroll-show"], R = 0 <= y.indexOf("a2a_vertical_style");
        D && !isNaN(D) && (a2a.svg.load(), T && "unset" != T && a2a.svg.works() && (L && "unset" != L && (j.backgroundColor = L), N && "unset" != N.trim() && (N = N.trim())), h.style.lineHeight = P.height = P.lineHeight = I, P.width = 2 * D + "px", P.fontSize = "16px", R && (P.height = P.lineHeight = D / 2 + "px", P.fontSize = "10px", P.width = D + "px"), H && a2a.scrollToggle(h, H), 32 != D && (j.backgroundSize = j.height = j.lineHeight = j.width = I, P.borderRadius = j.borderRadius = (.14 * D).toFixed() + "px", P.fontSize = (parseInt(P.height, 10) + (R ? 4 : 0)) / 2 + "px")), a2a.kit.facebook_like = function () {
            pe.href = E, pe.width = "90", pe.layout = "button_count", pe.ref = "addtoany", pe = p(V, pe), V.style.width = pe.width + "px";
            ...
            var e = _.twitter, a = "string" == typeof e ? e.lastIndexOf("@") : null;
            a && -1 !== a && (a++, a = (a = e.substr(a).split(" ", 1))[0].replace(/:/g, "").replace(/\//g, "").replace(/-/g, "").replace(/\./g, "").replace(/,/g, "").replace(/;/g, "").replace(/!/g, ""), pe.related = a + ",AddToAny"), pe = p(V, pe);
            ...
            pe["pin-config"] = "beside", pe["pin-do"] = "buttonPin", pe.media = B, pe.url = E, pe = p(V, pe);
            ...
            for (var e in pe.onsuccess = "a2a.kit.linkedin_share_event", pe.url = E, pe = p(V, pe)) ue += " data-" + e + '="' + pe[e] + '"';
            var a, t, n;
        ...
        for (var $ = 0; $ < b; $++) {
            var U, W, q, G, V = w[$], Y = V.className, K = Y.match(/a2a_button_([\w\.]+)(?:\s|$)/),
                J = 0 <= Y.indexOf("a2a_dd"), X = 0 <= Y.indexOf("a2a_counter"), Q = !!K && K[1], Z = V.childNodes,
                ee = u(Q), ae = k && r[Q] ? r[Q].name : ee[0], te = " noopener", ne = "_blank",
                ie = k && r[Q] ? r[Q].icon : ee[1], oe = k && r[Q] ? r[Q].color : ee[2] || "CAE0FF", le = ee[3] || {},
                re = le.type, se = ee[4], ce = !1, de = !1, ue = "", pe = {};
            if (J) e.target = V, a2a.init(d, e), oe = "0166FF", ie = Q = "a2a", de = X && 1; else if ("feed" == Q || "print" == Q) te = ne = ""; else if (X && Q && g(Q, c)) de = 1; else if (Q && g(Q, s)) {
                if ("1" === navigator.doNotTrack || "1" === window.doNotTrack) continue;
                a2a.kit[Q](), ce = 1
            }
            if (Q && !g(Q, ["google_plus", "stumbleupon"]) && !ce) {
                if (J || (V.target = ne, !k || !r[Q] && u(Q, !0) ? "feed" == Q ? V.href = V.href || o.linkurl : (V.href = "/#" + Q, "js" === re ? a2a.add_event(V, "click", m) : (a2a.add_event(V, "mousedown", m), a2a.add_event(V, "keydown", m)), V.rel = "nofollow" + te) : V.href = (t = Q, l = n = void 0, i = p(a = V, {})["a2a-follow"], l = r[t], i && l && (n = l.url.replace("${id}", i)), n || a.href), V.a2a = {}, V.a2a.customserviceuri = se, V.a2a.stype = re, V.a2a.linkurl = o.linkurl, V.a2a.servicename = ae, V.a2a.safename = Q, le.src && (V.a2a.js_src = le.src), le.url && (V.a2a.url = le.url), le.pu && (V.a2a.popup = 1), le.media && (V.a2a.media = 1), h.a2a_codes = h.a2a_codes || [], h.a2a_codes.push(Q), k || a2a.add_event(V, "click", function (o, l, r, s, c) {
                    return function (e) {
                        var a = "js" === c.a2a.stype, t = c.a2a.js_skip, n = screen.height,
                    ...
                    for (var me, fe, _e, ge = 0, he = Z.length; ge < he; ge++) if (_e = (fe = "string" == typeof (me = Z[ge].className)) && ("a2a_label" === me || 0 <= me.indexOf("a2a_ignore")), 1 == Z[ge].nodeType && (_e || (G = !0), fe && 0 <= me.indexOf("a2a_count"))) {
                        q = !0;
                        break
                    }
                    if (!G) {
                    ...
                    V.appendChild(U), (U = document.createElement("span")).className = "a2a_label", U.innerHTML = ae || ("feed" == d ? a2a.c.localize.Subscribe : a2a.c.localize.Share), ae || (U.className += " a2a_localize", U.setAttribute("data-a2a-localize", "inner," + ("feed" == d ? "Subscribe" : "Share"))), V.appendChild(U)
                }
                if (R && D && D < 20 && (de = !1), de && !q) {
                    for (var ve in (U = document.createElement("span")).className = "a2a_count", U.a2a = {}, U.a2a.kit = h, P) U.style[ve] = P[ve];
                    V.appendChild(U), J ? (U.a2a.is_a2a_dd_counter = 1, h.a2a_dd_counter = U, a2a.counters.get("facebook", U, O)) : a2a.counters.get(Q, U, O)
                }
    ...
    counters: {
        get: function (n, i, e, a) {
            a2a_config.counts;
            var o, t, l = decodeURIComponent(e), r = a2a.counters.bonus(n, l, e, i.a2a.kit), s = "",
                c = a2a.counters[n], d = c.api, u = (c.cb, i.a2a.is_a2a_dd_counter);
            !a && r && (s = "2", a2a.counters.get(n, i, r, !0)), "undefined" == typeof (o = c[l] = c[l] || {}).num ? (o.queued = o.queued || [], o.queued.push(i), c.n = c.n || 0, c.n++, c["cb" + c.n] = function (e) {
                ...
                if (void 0 !== a) for (var t = 0; t < o.queued.length; t++) queued_count_element = o.queued[t], o.num = a, queued_count_element.a2a.is_a2a_dd_counter ? a2a.counters.sum(queued_count_element, a, n + s) : a2a.counters.set(queued_count_element, a, n + s)
        ...
        sum: function (e, a, t) {
            var n = e.a2a.kit, i = n.a2a_counts_sum || 0, o = n.a2a_counts_summed || [];
        ...
        format: function (e) {
            var a = a2a.counters.format, t = "localize";
    ...
    overlays: function () {
        var e = a2a.c.overlays || [], a = !!a2a.evOpts() && {passive: !0}, t = window, n = t.innerWidth,
            i = t.innerHeight, y = n && (n < 375 || i < 375) ? 150 : 200, k = 200, w = location.href,
            b = document.title || w;
        ...
        function o(e, a, t, n) {
            ...
            if (a2a.matches(m, n) && "false" !== m.getAttribute("data-a2a-overlay")) {
                ...
                o = a2a.getPos(m), a.style.display = "", s = a.clientHeight || a.offsetHeight, c = a.clientWidth || a.offsetWidth, t[0] && ("bottom" === t[0] ? g = m.height - s : "center" === t[0] && (g = x((m.height - s) / 2))), t[1] && ("right" === t[1] ? _ = m.width - c : "center" === t[1] && (_ = x((m.width - c) / 2))), d = o.left + _, u = o.top + g, a.style.left = d + "px", a.style.top = u + "px", a.setAttribute("data-a2a-media", m.src), (a.a2a_mediaNode = m).alt ? a.setAttribute("data-a2a-title", m.alt) : a.setAttribute("data-a2a-title", b), !h || "#" !== h.substr(0, 1) && "http" !== h.substr(0, 4) ? a.setAttribute("data-a2a-url", w) : (p = "#" === h.substr(0, 1) ? w.split("#")[0] + m.longDesc : h, a.setAttribute("data-a2a-url", p))
        ...
        for (var l = 0, r = e.length; l < r; l++) {
            var s, c = e[l], d = c.services || ["pinterest", "facebook"], u = "", p = c.html, m = c.position,
                f = c.style, _ = c.size || 32, g = c.target, x = Math.round;
            if (m = m && 2 < m.length ? m.split(" ") : ["top", "left"], f = !f || "horizontal" !== f && "default" !== f ? "vertical" : "default", g = g || "img", p) document.body.insertAdjacentHTML("beforeend", p), s = document.body.lastChild; else {
    ...
    init_show: function () {
        var e = a2a_config, a = a2a[a2a.type], t = a2a.show_menu, n = a2a.init_show, i = a2a.n;
    ...
    unindexed: function (o, e) {
        var a = document, t = a2a.getByClass, n = t("a2a_kit", a),
            i = a2a.HTMLcollToArray(a.getElementsByName("a2a_dd")).concat(t("a2a_dd", a));

        function l(e) {
            for (var a, t, n = 0, i = e.length; n < i; n++) if (("undefined" == typeof (a = e[n]).a2a_index || "" === a.a2a_index) && a.className.indexOf("a2a_target") < 0 && a.parentNode.className.indexOf("a2a_kit") < 0 && (t = o(a)), t) return t;
            return null
        }
    ...
    matches: function (e, a) {
        ...
        if (e.matches) t = "matches"; else if (e[i]) t = i; else {
    ...
    in_array: function (e, a, t, n, i) {
        if ("object" == typeof a) {
            e = e.toLowerCase();
            for (var o, l = a.length, r = 0; r < l; r++) if (o = n ? a[r][n] : a[r], o = i ? o[i] : o, t) {
    ...
    scrollToggle: function (e, a) {
        ...
        var n, o = window, t = parseInt(a[0], 10) || 0, i = parseInt(a[1], 10) || 0, l = function (e, a, t) {
            var n = o.pageYOffset, i = document.documentElement.scrollHeight - o.innerHeight - n;
    ...
    miniLeaveDelay: function () {
        var e = a2a.type, a = "a2a" + e, t = a2a.gEl;
    ...
    toggle_dropdown: function (e, a) {
        if ("none" != e || !a2a[a].no_hide) {
            var t = (0, a2a.gEl)("a2a" + a + "_dropdown"), n = (document.activeElement, a2a.show_menu.key_listener);
    ...
    do_find: function () {
        var e, a = a2a.type, t = a2a[a].main_services, n = t.length, i = a2a.gEl("a2a" + a + "_find").value,
            o = a2a.in_array;
        if ("" !== i) {
            e = i.split(" ");
    ...
    selection: function (e) {
        ...
        if (a && "" !== a) return a;
        if (a2a["n" + a2a.n].linkurl === location.href && -1 === ["facebook", "twitter", "linkedin"].indexOf(e)) for (var o, l, r = 0; r < i; r++) if (o = (o = n[r].getAttribute("name")) ? o.toLowerCase() : "", l = (l = n[r].getAttribute("property")) ? l.toLowerCase() : "", o && "description" === o || l && "og:description" === l) {
    ...
    cbs: function (e, a) {
        var t = a2a.c.callbacks || [], n = a2a.c.tracking_callback, i = {};
        n && (n[e] ? t.push(n) : n[0] == e ? (i[e] = n[1], t.push(i)) : "function" == typeof n && (i[e] = n, t.push(i)), a2a.c.tracking_callback = null);
        for (var o, l = 0, r = t.length; l < r; l++) if ("function" == typeof (o = t[l][e]) && (returned = o(a), "ready" == e && (o = null), "undefined" != typeof returned)) return returned
    },
    linker: function (e) {
        var a, t, n = location.href, i = document.title || n, o = e.parentNode,
            l = a2a["n" + (o.a2a_index || o.parentNode.a2a_index || a2a.sole_index || a2a.n)], r = l.type,
            s = e.a2a.safename, c = l.linkurl_implicit && n != l.linkurl ? n : l.linkurl,
            d = encodeURIComponent(c).replace(/'/g, "%27"), u = l.linkname_implicit && i != l.linkname ? i : l.linkname,
            p = encodeURIComponent(u).replace(/'/g, "%27"), m = l.linkmedia,
            ...
            h = e.a2a.customserviceuri || !1, v = e.a2a.stype, y = e.a2a.js_src, k = e.a2a.url, w = e.a2a.media,
            b = a2a.c.templates, x = b[s], A = "email", E = navigator.userAgent,
        ...
        if (w && f) e.a2a.js_skip = 1; else if (v && "js" == v && y) e.target = "", "javascript:" == y.substr(0, 11) ? (a = y.replace("${link}", c.replace(/'/g, "\\'")), (t = document.createElement("script")).textContent = a.substr(11), document.head.appendChild(t)) : a2a.loadExtScript(y), a = "#" + s; else if (k && (s != A || s == A && (a2a.is_mobile || C)) && !g) {
            if (e.target = "", "object" == typeof x) for (var B in x) k = a2a.urlParam(k, B, S(x[B])); else "string" == typeof x && (k = a2a.urlParam(k, "text", S(x)));
        ...
        return e.href = a || "http" + a2a.c.http_s + "://www.addtoany.com/add_to/" + s + "?linkurl=" + d + "&linkname=" + p + (f ? "&linkmedia=" + f : "") + g + function T() {
            var e = "";
            return x ? e = "&" + a2a.serialize({template: x}) : b[A] && v && v == A && (e = "&" + a2a.serialize({template: b[A]})), e
        }() + ("feed" == r ? "&type=feed" : "") + "&linknote=" + _, !0
    },
    animate: function (e, a, t) {
        if (a) {
            var n = a2a.isDisplayed(a), i = a.classList, o = "a2a_starting", l = "transitionend";
            if ("show" === e) {
                if (n) return;
                !function r(e, a) {
    ...
    overlay: {
        show: function () {
            var e = a2a.gEl, n = a2a.type, a = "a2a" + n, t = e("a2a_overlay"), i = e(a + "_find");
            "none" === a2a.getStyle(t, "display") && (a2a.animate("show", t), a2a.overlay.key_listener = a2a.add_event(document, "keydown", function (e) {
                var a = (e = e || window.event).which || e.keyCode, t = document.activeElement;
                27 == a && i != t ? a2a.hide_modals(n) : 40 < a && a < 91 && i != t && i.focus()
            }))
        }, hide: function (e) {
            var a = a2a.gEl("a2a_overlay"), t = a2a.overlay, n = t.key_listener;
    ...
    hide_modals: function (e) {
        var a = a2a.gEl, t = "a2a" + e, n = a(t + "_full"), i = a("a2a_overlay"), o = a("a2a_modal");
    ...
    show_full: function () {
        var e = "a2a" + a2a.type, a = a2a.gEl, t = a2a.getByClass, n = a(e + "_full"), i = t("a2a_full_header", n)[0],
            o = a(e + "_full_services"), l = t("a2a_full_footer", n)[0];
    ...
    copyLink: function (e) {
        var a = a2a.gEl, t = (a2a.getStyle, a("a2apage_full")), n = (a("a2a_overlay"), a("a2a_modal")),
            i = a("a2a_copy_link"), o = a("a2a_copy_link_copied"), l = a("a2a_copy_link_text");
    ...
    thanks: {
        off: function () {
            ...
            var e = a2a.ads, a = "a2a" + a2a.type, t = a2a.gEl, n = a2a.getStyle, i = t("a2a_modal"),
                o = t(a + "_full"), l = t("a2a_thanks"), r = a2a_config.thanks, s = a2a.thanks.off();
    ...
    postClick: function (e) {
        var a = window, m = document, t = a2a.thanks, n = "blur", i = "focus", o = "waiting";
        a2a.ads;
        ...
        t[o] || (t[o] = 1, a.addEventListener(n, function r() {
            a.removeEventListener(n, r), a.addEventListener(i, l), function p(e) {
                var a, t = a2a.gEl, n = "", i = e ? e.a2a_index : null,
                    o = e ? e.a2a_codes : ["facebook", "twitter", "email"], l = a2a["n" + (i || a2a.n)], r = l.type,
                    s = t("a2a_thanks"), c = "a2a_thanks_kit", d = t(c);
    ...
    ads: {
        lit: function () {
            ...
            var i = a2a.gEl, o = (a2a.type, "a2a_thanks_a2a_ad"), a = "a2a_thanks_pub_ad", l = i(o), r = i(a),
                s = i("a2a_thanks"), t = a2a_config.thanks,
            ...
            function d() {
                var e = window.innerHeight, a = e < 460, t = Math.max(.5, (e / 600).toFixed(1)),
    ...
    stats: function (a) {
        if (a2a.stats.a2a = a2a.stats.a2a || {}, !a2a.stats.a2a[a]) {
            var e, t, n, i, o, l, r = "&domain=" + encodeURIComponent(location.href.split("/")[2]), s = a2a.ads,
                c = s.has();
    ...
    GA: function () {
        var l = window, c = a2a.type, d = "feed", e = function () {
        }, a = function () {
            if ("function" == typeof urchinTracker) a2a.GA.track = function (e, a, t, n, i) {
                ...
                a2a.GA.track = function (e, a, t, n, i) {
                    if (c != d) {
                        var o = t || a2a["n" + a2a.n].linkurl, l = a2a.c.callbacks;
                        !function r() {
    ...
    add_services: function () {
        var e, a = a2a.type, t = a2a.gEl, n = parseInt(a2a[a].num_services), i = t("a2a" + a + "_full_services"),
            o = t("a2a" + a + "_mini_services");
        if (a2a[a].custom_services) {
            var l = (d = a2a[a].custom_services).length, r = a2a.make_service;
            d.reverse();
    ...
    util_frame_make: function (e) {
        var a = document.createElement("iframe"), t = document.createElement("div"), n = encodeURIComponent,
            i = document.referrer ? n(document.referrer) : "", o = n(location.href),
    ...
    util_frame_listen: function (e) {
        a2a.util_frame_make(e), window.postMessage && !a2a[e].message_event && (a2a.add_event(window, "message", function (e) {
            if (".addtoany.com" === e.origin.substr(-13)) {
                var a = "string" == typeof e.data ? e.data.split("=") : [""], t = a[0].substr(4), n = a[1],
                    i = t.substr(0, 4);
    ...
    fix_icons: function () {
        var e = a2a.ieo();
        if (e && e < 9) {
            var a = (a = a2a.getByClass("a2a_s_a2a", document))[0], t = a2a.fix_icons.tryNum || 0;
    ...
    arrange_services: function () {
        var e = a2a.type, a = a2a.c.prioritize;
        a && a2a.top_services(a, e), a2a.add_services()
    },
    top_services: function (e, a, t) {
        var n = a || a2a.type, i = a2a.in_array, o = a2a.make_service, l = parseInt(a2a[n].num_services),
            r = a2a.gEl("a2a" + n + "_full_services"), s = a2a.gEl("a2a" + n + "_mini_services"),
            c = a2a.getByClass("a2a_i", r, "a"), d = a2a.getByClass("a2a_i", s, "a"), u = [];
        if (e) {
            var p = e.length - 1;
            for (t = t; -1 < p; p--) {
    ...
    css: function () {
        var e, a, t = a2a.type, n = a2a.c, i = n.css = document.createElement("style"), o = n.color_main || "EEE",
            l = n.color_bg || "FFF", r = n.color_border || "CCC", s = n.color_link_text || "0166FF",
            c = n.color_link_text_hover || "2A2A2A", d = (n.color_link_text_hover, n.color_link_text || "2A2A2A"),
            u = (o.toLowerCase(), n.color_link_text || "2A2A2A"), p = n.color_border || r, m = ".a2a_", f = m + "menu",
            _ = "border", g = "background-color:", h = "color:", v = "margin:", y = "padding:";
    ...
    svg_css: function () {
        a2a.init("page");
        var e = a2a.c.css.sheet || a2a.c.css.styleSheet || {}, a = "insertRule" in e, t = "addRule" in e;
    ...
    svg: {
        ...
        set: function (e) {
            var a = a2a.svg, t = a.queue;
            if (icons = a.icons = e, svg_tag_open = a.tagO, svg_tag_close = a.tagC, icons.a2a) for (var n, i, o, l = 0, r = t.length; l < r; l++) i = (n = t[l]).name, color = n.color, o = icons[i] ? icons[i] : icons.a2a, o = color ? a.fill(o, color) : o, n.node.innerHTML = svg_tag_open + o + svg_tag_close
        },
        load: function (t) {
            var n = a2a.svg.works(), i = new window.Image;
            i.onerror = function () {
                a2a.svg.loadCSS(!1)
            }, i.onload = function () {
        ...
        loadCSS: function (e) {
            var a = a2a.static_addtoany, t = a2a.c.static_server, n = a2a.fix_icons, i = a2a.svg.works(),
                o = window.document.createElement("link"), l = e && i && t != a ? t + "/" : a + "/svg/";
        ...
        loadJS: function () {
            var e = document, a = a2a.c.static_server, t = e.createElement("script"),
                n = e.getElementsByTagName("script")[0], i = a != a2a.static_addtoany ? a + "/" : a + "/svg/";
    ...
    make_service: function (c, d, e, a, t, n, i) {
        var o, l, u = document.createElement("a"), r = a2a.c, s = function () {
                a2a.linker(this)
            }, p = a2a.type, m = (t = t || {}, "a2a_svg a2a_s__default"), f = r.icon_color, _ = f ? f.split(",", 2) : f,
            g = _ ? _[0] : _, h = _ ? _[1] : _;
        return u.rel = "nofollow noopener", u.className = "a2a_i", u.href = "/#" + d, u.target = "_blank", u.a2a = {}, u.a2a.safename = d, u.a2a.servicename = c, u.a2a.serviceNameLowerCase = c.toLowerCase(), u.a2a.serviceIcon = e, u.a2a.serviceColor = a, u.a2a.serviceType = t.type, u.innerHTML = "<span></span>" + c + " ", o = u.firstChild, t.type && (u.a2a.stype = t.type), t.src && (u.a2a.js_src = t.src), t.url && (u.a2a.url = t.url), t.pu && (u.a2a.popup = 1), t.media && (u.a2a.media = 1), n && (u.a2a.customserviceuri = n), i ? (o.style.backgroundImage = "url(" + i + ")", o.className = m) : f && a2a.svg.works() ? (o.className = m + " a2a_s_" + e, g && "unset" != g ? o.style.backgroundColor = g : a && (o.style.backgroundColor = "#" + a), h && (h = h.trim())) : e ? (o.className = m + " a2a_s_" + e, a && (o.style.backgroundColor = "#" + a)) : o.className = m, i || "pending" !== (l = a2a.svg.get(e, o, h)) && (o.innerHTML = l), "js" === u.a2a.stype ? a2a.add_event(u, "click", s) : (a2a.add_event(u, "mousedown", s), a2a.add_event(u, "keydown", s)), a2a.add_event(u, "click", function (e) {
            var a = a2a["n" + a2a.n], t = {node: u, service: c, title: a.linkname, url: a.linkurl, media: a.linkmedia},
                n = a2a.cbs("share", t);
            ...
            var a = encodeURIComponent, t = a2a["n" + a2a.n], n = "page" == p ? "pages" : "subscriptions",
                i = "page" == p ? "AddToAny Share/Save Button" : "AddToAny Subscribe Button", o = "js" === u.a2a.stype,
                l = u.a2a.js_skip, r = screen.height,
    ...
    localize: function () {
        var i = document, e = a2a.getByClass("a2a_localize", i), a = a2a.c.localize, t = a2a.locale;
...
a2a.c = a2a_config, a2a.make_once = function (e) {
    if (a2a.type = a2a.c.menu_type || e, !a2a[a2a.type] && !window["a2a" + a2a.type + "_init"]) {
        a2a[a2a.type] = {}, window.a2a_show_dropdown = a2a.show_menu, window.a2a_miniLeaveDelay = a2a.miniLeaveDelay, window.a2a_init = a2a.init, a2a["create_" + a2a.type + "_html"] = function (e, a) {
            var t, n, r, i, o, l, s = a2a.html_container, c = "", d = "", u = a2a.gEl, p = a2a.type = e, m = "a2a" + p,
                f = a2a.c, _ = a2a.ieo(), g = a2a.has_menter, h = document.createElement("i"),
                v = document.createDocumentFragment(), y = document.createDocumentFragment(),
                k = (document.createElement("a"), f.icon_color), w = k ? k.split(",", 2) : k, b = w ? w[0] : w,
                x = w ? w[1] : w, A = "a2a_svg a2a_s__default a2a_s_", E = x || "#FFF",
                ...
                B = a2a.locale, T = f.localize;
            if (a2a.css(), T = f.localize = {
                ...
                var F = "a2a_menu_container", L = u(F);
                s = a2a.html_container = L && !a2a.init_show.a2a_done ? L : document.createElement("div");
                a2a.add_event(s, "click", a2a.stopPropagation), a2a.add_event(s, "touchstart", a2a.stopPropagation, !!a2a.evOpts() && {passive: !0}), s.innerHTML = d + c
            }
            if (s.id != F && (s.style.position = "static", _ && _ < 9 ? document.body.insertBefore(s, document.body.firstChild) : document.body.insertBefore(s, null)), (o = u(m + "_dropdown")) && g && (a2a.add_event(o, "mouseenter", a2a.miniEnterStay), a2a[p].onclick || a2a.add_event(o, "mouseleave", a2a.miniLeaveDelay)), (r = u(m + "_find")) && (a2a.add_event(u(m + "_find_icon"), "click", a2a.focus_find), a2a.add_event(r, "click", a2a.focus_find), a2a.add_event(r, "keyup", a2a.do_find)), (l = u("a2a_copy_link_icon")) && a2a.add_event(l, "click", function () {
            ...
            a2a[p].services = a.most.concat(a.email), a2a.add_event(u("a2a_overlay"), "click", function (e) {
                ...
                var a = (e = e || window.event).which || e.keyCode, t = a2a.type;
                if (13 == a) {
        ...
        var a = {
            page: {
                most: [["Facebook", "facebook", "facebook", "3B5998", {
                    media: 1,
                    pu: 1
                }], ["Twitter", "twitter", "twitter", "55ACEE", {pu: 1}], ["Email", "email", "email", "0166FF", {url: "mailto:?subject=${title}&body=${link}"}], ["Pinterest", "pinterest", "pinterest", "BD081C", {
                    type: "js",
                    src: "https://assets.pinterest.com/js/pinmarklet.js",
                    media: 1,
                    pu: 1
                }], ["LinkedIn", "linkedin", "linkedin", "007BB5", {pu: 1}], ["Reddit", "reddit", "reddit", "ff4500"], ["WhatsApp", "whatsapp", "whatsapp", "12AF0A"], ["Gmail", "google_gmail", "gmail", "DD5347", {
                    type: "email",
                    pu: 1
